...
export default function Footer() {
  return (
    <footer className='bg-dark-green py-10 px-5' role='footer'>
      <div className='max-w-5xl flex flex-col items-center sm:items-stretch justify-center gap-5'>
        ...
        <div className='flex flex-col sm:flex-row gap-5 sm:justify-between items-center'>
          <div className='flex gap-5'>
